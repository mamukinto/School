...
public class DAOClassroom implements DAOService{
    public static String write(DBObject dbObject) throws SchoolException {
        Classroom classroom = (Classroom) dbObject;
    ...
    public static void writeAll(List<Classroom> classrooms) {
    ...
    public static List<Classroom> readAll() throws SchoolException {
        ...
        if  (arrayOfFiles != null) {
            ...
            for (String nameOfFile : namesOfFiles) {
                Classroom classroom = (Classroom) read(nameOfFile);
